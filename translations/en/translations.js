export const englishTranslations = {
    ...
    homepageAboutMeSummary: `I started playing with computers from a young age. I was always fascinated by the way they worked and how they could be used to create things. 
    I started with simple games and animations, and then moved on to building websites. I love the feeling of creating something from scratch and seeing it come to life. 
    I am always looking for new challenges and ways to improve my skills.`,
    homepageAboutMeResumeButton: "Resume",
    homepageAboutMeReadMoreButton: "Read more",

    //aboutMe
    aboutMeTitle: "I have always loved tech",
    aboutMeSubtitle: "Looking for my ",
    aboutMeQuickStoryTitle: `My quick story`,
    aboutMeQuickStory: `<span>I was introduced to computers at 6 years old.</span> Back then I only played videogames, 
    ...
    aboutMeAsDeveloperTitle: `As a developer`,
    aboutMeAsDeveloper: `I pay close <span>attention to the readability of my code</span>. I might put something together as quickly as possible to make it work, but afterwards I like to spend
    ...
    aboutMeAsPersonTitle: `As a person`,
    aboutMeAsPerson: `I'm a very <span>social and resourceful person</span>. I love to meet new people and learn about their lives. 
    ...
    aboutMeAsColleagueTitle: `As a colleague`,
    aboutMeAsColleague: `<span>I'm a team player</span>, I feel comfortable interacting with both the <span>technically oriented</span> people as well as the <span>artistically oriented</span> ones.
    ...
    spinakerGoal: `When I arrived in Katowice I was greeted by the other students that were selected to participate in this project. 
    ...
    spinakerCourse: `The remainder of the week was spent working on the website. We had to <span>create a design for the website and then implement it.</span>
    ...
    spinakerResult: `This project was a great experience. <span>I was able to work with students from all over Europe and I was able to learn a lot about the agile methodology. </span>
    ...
    The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.`,
    thirdRecap: `Make it fast and a cool conversation starter for interviews. Always have you resume on hand.`,
    ...
    footerBuiltBy: `© 2022, Built by Michael Vanhoutte`,
    footerLinks: `Links`,
    footerAbout: `About`,
    footerBlog: `Blog`,
